...
<body class="lockscreen" style="height: 100%; overflow: hidden;">
<!-- Automatic element centering -->
<div class="lockscreen-wrapper">
    <div class="lockscreen-logo" style="padding: 5%">
    </div>
    <!-- User name -->
    ...
    <div class='text-center'><b>
        <a href="{{route("getLogout")}}" style="text-decoration: none; color: white">{{cbLang('text_or_sign_in')}}</a></b>
    </div>
    <div class='lockscreen-footer text-center' style="margin-top: 50%">
        Copyright &copy; {{date("Y")}} by Eventy<br>
        All rights reserved
    </div>
</div><!-- /.center -->
