...
<header class="main-header">
    ...
    @if(Str::contains(URL::current(), 'dashboard_event'))
        <a href="{{URL::to('eo')}}" title='{{Session::get('event_name')}}' class="logo">{{Session::get('event_name')}}</a>
    @else
        <a href="{{URL::to('eo')}}" title='{{Session::get('appname')}}' class="logo">{{CRUDBooster::getSetting('appname')}}</a>
    @endif
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ cbLang('left') }}">
                                <a href="{{ route('getEOProfile') }}" class="btn btn-default btn-flat"><i
                                            class='fa fa-user'></i> {{cbLang("label_button_profile")}}</a>
                            </div>
                            <div class="pull-{{ cbLang('right') }}">
                                <a title='Lock Screen' href="{{ route('getEOLockScreen') }}" class='btn btn-default btn-flat'><i class='fa fa-key'></i></a>
