...
<div class='panel panel-default' id="root">
    <div class="panel-body">
        <form method="POST" action="{{URL::to('eo/dashboard_event/category')}}" id="form">
          @csrf
          ...
          <div class='form-group header-group-0 ' style="">
            ...
            <div class="col-sm-10">
              <input type='number' title="Total Winner" required class='form-control' placeholder='You can only enter the number only' name="total_winner"/>
              <div class="text-danger"></div>
              <p class='help-block'></p>
            </div>
          </div>
